  ...
  <script>
    ...
    function registrarPrintLog() {
      fetch('api/settings.php', {
        method: 'POST',
        body: new URLSearchParams({ action: 'log_event', event: 'print_screen', page: 'gastos', user_agent: navigator.userAgent }),
      });
    }
    ...
    // Detecta screenshot em mobile (Android/iOS não tem evento, mas pode usar perda de foco)
